...
ActiveRecord::Schema.define(version: 20160808201559) do
  ...
  add_index "agendas", ["minute_id"], name: "index_agendas_on_minute_id", using: :btree
  ...
  create_table "newsletter_lists", force: :cascade do |t|
    t.string   "name"
    t.string   "email"
    t.boolean  "added"
    t.datetime "created_at", null: false
